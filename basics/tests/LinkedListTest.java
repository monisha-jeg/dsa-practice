...
public class LinkedListTest {
    public static void run() {
        ...
        assertEquals(List.of(200, 1, 2, 3, 4, 100, 5, 300, 6), l.values(), "Contents after insertNodeAt operations");

        l.deleteNodeAt(5);
        l.deleteNodeAt(0);
        l.deleteNodeAt(5);
        assertEquals(List.of(1, 2, 3, 4, 5, 6), l.values(), "Contents after deleteNodeAt operations");
        ...
        l.reverse();
        assertEquals(List.of(6, 5, 4, 3, 2, 1), l.values(), "Contents after reverse");

        l.recursiveReverse(/* complex= */ false);
        assertEquals(List.of(1, 2, 3, 4, 5, 6), l.values(), "Contents after recursiveReverse(false)");

        l.recursiveReverse(/* complex= */ true);
        assertEquals(List.of(6, 5, 4, 3, 2, 1), l.values(), "Contents after recursiveReverse(true)");
    }
